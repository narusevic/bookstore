...
@Alternative
@ApplicationScoped
public class CompBAlternative implements ICompB {
    ...
    public Future<String> asyncMethod() {
        System.out.println("CompBAlternative starts working on a big task...");
        try {
            Thread.sleep(2000); // sleep for 10 seconds
        } catch (InterruptedException e) {
        }
        System.out.println("CompBAlternative: big task completed.");
        return new AsyncResult<>("BIG result from component BAlternative :)");
    }
    ...
    public Future<String> asyncMethodSpec() {
        ...
        return new AsyncResult<>("Not Specialized COMPBAlternative :)");
    }
